...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--task', default='ctdet_mid',
                             help='ctdet | ddd | multi_pose | exdet')
    self.parser.add_argument('--dataset', default='table_mid',
    ...
    self.parser.add_argument('--output_dir', default='../data/table/', 
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')   
    self.parser.add_argument('--demo_dir', default='../viz_custom_ndl/', 
    ...
    self.parser.add_argument('--load_model', default='../exp/ctdet_mid/train_wireless_ndl/model_last.pth',
                             help='path to pretrained model')
    self.parser.add_argument('--load_processor', default='../exp/ctdet_mid/train_wireless_ndl/processor_last.pth', 
    ...
    # model
    self.parser.add_argument('--arch', default='resfpnhalf_18', 
    ...
    self.parser.add_argument('--wiz_2dpe', action='store_false', default=True, ##store_falseに改変（デフォでtrueにしたい）
    ...
    self.parser.add_argument('--wiz_stacking', action='store_false', default=True, #store_falseに改変（デフォでtrueにしたい）
    ...
    self.parser.add_argument('--tsfm_layers', type=int, default=4,
                             help='layers of base transformers')
    self.parser.add_argument('--stacking_layers', type=int, default=4,
                             help='single or multiple')
    ...
    self.parser.add_argument('--upper_left', action='store_true', default=True,##store_falseに改変（デフォでtrueにしたい）
    ...
    self.parser.add_argument('--nms', action='store_true', default=False,#store_trueに改変（不要なのでデフォルトをfalseにした）
                             help='run nms in testing.')
    self.parser.add_argument('--K', type=int, default=3000,
    ...
    self.parser.add_argument('--wiz_detect',  action='store_false', default=True, #store_falseに改変（デフォルトをtrueにした）
    ...
    self.parser.add_argument('--no_color_aug', action='store_true',
                             help='not use the color augmenation '
                                  'from CornerNet')
    self.parser.add_argument('--MK', default=5000,
